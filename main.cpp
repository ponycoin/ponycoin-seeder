...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Ponycoin-seeder\n"
...
static const string mainnet_seeds[] = {"pnc.brony.co", ""};
static const string testnet_seeds[] = {"testnet-seed.alexykot.me",
                                       "testnet-seed.ponycoin.petertodd.org",
                                       "testnet-seed.bluematt.me",
                                       "testnet-seed.ponycoin.schildbach.de",
                                       ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("pnc.brony.co", 6933), true);
  }
  do {
